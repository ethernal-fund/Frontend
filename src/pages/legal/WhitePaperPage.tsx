...
const WhitepaperPage: React.FC = () => {
  ...
  const sections: { heading: string; body: string | string[] }[] = [
    {
      heading: t('whitepaper.sections.executiveSummary.title'),
      body:    t('whitepaper.sections.executiveSummary.body'),
    },
    {
      heading: t('whitepaper.sections.team.title'),
      body:    t('whitepaper.sections.team.body'),
    },
    {
      heading: t('whitepaper.sections.disclaimer.title'),
      body:    t('whitepaper.sections.disclaimer.body'),
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <div className="bg-gray-800 text-white py-4 px-4">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <span className="text-xs text-gray-400">
            {t('legal.version', { version: '1.1' })} · {t('whitepaper.subtitle').split('·').pop()?.trim()}
          </span>
        </div>
      </div>
      ...
      <div className="bg-linear-to-br from-gray-800 to-green-900 text-white py-12 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-2">{t('whitepaper.title')}</h1>
          <p className="text-gray-300 text-sm">{t('whitepaper.subtitle')}</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="border-b border-gray-100 bg-yellow-50 px-8 py-6">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4 flex items-center gap-2">
              <FileText size={13} />
              {t('whitepaper.downloadSection.title')}
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href="/legal/Ethernal_Fund_Whitepaper_v1_1_EN.pdf"
                download
              ...
              >
                <Download size={14} />
                {t('whitepaper.downloadSection.english')}
              </a>
              <a
                href="/legal/Ethernal_Fund_Whitepaper_v1_1_ES.pdf"
                download
              ...
              >
                <Download size={14} />
                {t('whitepaper.downloadSection.spanish')}
              </a>
            </div>
            <p className="text-xs text-gray-400 mt-3">
              {t('whitepaper.downloadSection.governingNote')}
            </p>
          </div>
